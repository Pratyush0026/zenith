      ...
      <div>
        ...
        >
          <div className="flex items-center gap-4">
            ...
            />
            <div className="text-xl text-gray uppercase tracking-wide font-bold  hover:text-purple-500">
              ZENITH
            </div>
          </div>
          ...
          <button className="py-3 px-6 font-bold text-sm border border-solid rounded-lg border-gray text-white hover:bg-purple">
            Sign Up
          </button>
          {toggle && (
            <motion.div
